...
feature, normally measured by a false positive ratio (FPR), also known
as the methods fall-out. The FPR is of course a function of the
selected thresholds, but if we select a treshold were say $\sim$95\%
...
five candidate peptides for a given feature. This could be compared to
the FPR of about $\frac{1}{200}$ for predictions of high-resolution
iso-electric focusing experiments~\cite{branca2014hirief}. The
retention time prediction have to improve quite a bit to come to level
