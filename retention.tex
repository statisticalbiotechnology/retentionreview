...
\ref{fig:methods} , while Table \ref{tab:rtmethods} lists a few of the
most popular retention time prediction methods from each category.
...
\caption{\label{fig:methods} {\bf Retention time prediction methods.}
  Each figure illustrates a category of retention time prediction
  methods. The details of each type of methods are described in detail
  in Section \ref{sec:rtpred}}.
\vspace{-7pt}
\end{figure}
