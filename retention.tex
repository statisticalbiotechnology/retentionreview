...
% what is the idea 
%In Paper IV we tested this hypothesis by calculating and evaluating
%two types of nonlinear gradients. Our results showed that the new
%gradients not only provided more uniform distributions of the
%peptides, but also led to an increase in the number of peptide
%identifications. In addition, they facilitated the identification of
%different peptide species compared to the typical linear gradients.
%The project was carried out in collaboration with the Mechtler group
%at the Research Institute of Molecular Pathology, Vienna.
