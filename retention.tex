...
peptide's elution peak (Figure~\ref{fig:rplc}, Panel D). Typically,
the more hydrophobic the peptide, the longer the retention time.
...
comprehensie coverages. Thus {\em de novo} retention time predictions
